...
The [previous lecture](\@ref(monte-carlo-introduction)) introduced the general idea behind Monte Carlo methods: using repeated random sampling to obtain numerical results.
